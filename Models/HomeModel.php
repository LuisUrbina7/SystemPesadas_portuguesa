<?php 
	...
	{	
		...
		public function getInfo(){
			...
			$queryOne = "SELECT IFNULL(COUNT(*),0) AS CANTIDAD FROM ADN.`adn_pesadas`";
			$queryTwo= "SELECT 
		...
		public function byTransfer()
		{
			...
			$sql = "SELECT PDA_NUMERO, 
					...
					FROM ADN.ADN_PESADAS
						JOIN ADN.adn_undagru ON UGR_PDT_CODIGO = PDA_UPP_PDT_CODIGO 
						AND UGR_UND_ID = PDA_UPP_UND_ID
						JOIN ADN.`adn_transportistas` ON PDA_DET_CODIGO = TRA_CODIGO
					WHERE PDA_TIPO = '2'
