<html lang="en" class="light-style" dir="ltr" data-theme="theme-default" data-assets-path="<?= media() ?>/" data-template="vertical-menu-template-free"><head>
    <meta charset="utf-8">
    ...
    <!-- Helpers -->
    <script src="<?= media() ?>/vendor/js/helpers.js"></script><style type="text/css">
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <div class="mt-3">
          <img src="<?= media() ?>/img/illustrations/page-misc-error-light.png" alt="page-misc-error-light" width="500" class="img-fluid" data-app-dark-img="illustrations/page-misc-error-dark.png" data-app-light-img="illustrations/page-misc-error-light.png">
        </div>
      </div>
    </div>
    <!-- /Error -->
