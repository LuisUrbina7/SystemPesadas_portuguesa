...
<body class="">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <p><strong>Cliente: </strong> <?= $data['page_data'][0]['CLT_NOMBRE'] ?> </p>
        ...
        <table>
            <tbody>
                <?php foreach ($data['page_data'] as $row) : ?>
                    ...
                    <tr>
                        <td>Descripción: </td>
                        <td class="left"><?= $row['PDT_DESCRIPCION'] ?> </td>
                    </tr>
                    <tr>
                        <td>Unidad: </td>
                        <td class="left"><?= $row['PDA_UPP_UND_ID'] ?> </td>
                    </tr>
                    <tr>
                        <td>Recibido: </td>
                        <td class="left"><?= $row['RECIBIDO'] ?> </td>
                    </tr>
                    <tr>
                        <td>Canastas: </td>
                        <td class="left"><?= $row['CANASTAS'] ?> </td>
                    </tr>
                    <tr>
                        <td>Extra: </td>
                        <td class="left"><?= $row['EXTRA'] ?> </td>
                    </tr>
                    <tr>
                        <td>Hora Inicio: </td>
                        <td class="left"><?= $row['INICIO'] ?> </td>
                    </tr>
                    <tr>
                        <td>Hora Fin: </td>
                        <td class="left"><?= $row['FIN'] ?> </td>
                    </tr>
                    <tr>
                        <td>Duración: </td>
                        <td class="left"><?= $row['DURACION'] ?> </td>
                    </tr>
                    <td colspan="2">
                        <hr class="divider">
                    </td>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var ajaxUrl = base_url + '/Ventas/generatePdf?id=' + numero + '&clt=' + codigo + '&scs=' + sucursal + '&height=' + bodyHeight;
