                ...
                <div class="card-body pt-4 p-2">
                    ...
                    <div id="container-items-details">
                        ...
                        <ul class="list-group">
                            ...
                            ?>
                                <a href="<?= base_url() ?>/DocumentGuia/content?id=<?= $details['DCL_NUMGUIA'] ?>&tr=<?= $details['TRA_CODIGO'] ?>&pdt=<?= $details['MCL_UPP_PDT_CODIGO'] ?>" data-pdt="<?= $details['MCL_UPP_PDT_CODIGO'] ?>" data-und="<?= $details['MCL_UPP_UND_ID'] ?>" data-exiscj="<?= number_format($details['CAJA'], 2) ?>" data-exisund="<?= number_format($details['UND_KG'], 2) ?>" data-canxund="<?= $details['PDT_LICLTSCAJA'] ?>" data-valor="<?= $valor ?>" data-number="<?= $details['DCL_NUMGUIA'] ?>" data-det="<?= $details['TRA_CODIGO'] ?>" data-omitido="<?= $details['OMITIDO'] ?>" onclick="setInfoDetails(this)">
