            ...
            <div class="modal-body p-2">
                ...
                <div class="table-responsive w-100 ">
                    ...
                    <table class="table table-hover" id="tableProducts">
                        <thead>
                            <tr>
                                <th class="font-weight-light py-1">Código de Producto</th>
                                <th class="font-weight-light py-1">Descripción</th>
                                <th class="font-weight-light py-1">Cajas</th>
                                <th class="font-weight-light py-1">Unidades</th>
                ...
                <div class="col-6">
                    <div class="card w-75">
                        <div class="card-header  py-2 text-center">
                            <h6 class="text-white text-capitalize ps-3 mb-0"><?= $data['page_data'][0]['PVD_NOMBRE'] ?> - <?= $data['page_data'][0]['MPR_DPV_NUMERO'] ?></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card h-100 ">
                <div class="row p-3 py-2">
                    <div class="col-md-4 row justify-content-center">
                        ...
                        <label for="arrival" class="col-5 col-form-label m-0  py-0">Llegada Camión : </label>
                        <div class="col-7">
                            <input type="datetime-local" class="form-control py-0 px-2  bg-info-doc" value="<?= date('Y-m-d H:i:s') ?>" id="arrival">
                        </div>
                    </div>
                    <div class="col-md-4 row">
                        <label for="TK" class="col-5 col-form-label m-0 py-0">Thermo king : </label>
                        <div class="col-7">
                            <input type="text" class="form-control py-0 px-2 bg-info-doc" value="0°" id="TK">
                        </div>
                    </div>

                    <div class="col-md-4 row">
                        <label for="TA" class="col-5 col-form-label m-0 py-0">Temperatura Ambiente : </label>
                        <div class="col-7">
                            <input type="text" class="form-control py-0 px-2 bg-info-doc" value="0°" id="TA">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-header pb-0 px-3">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex justify-content-start justify-content-md-end align-items-center">
                            <button type="button" class="btn btn-secondary py-2 px-3 m-0 mx-3 justify-content-center d-flex" onclick="aggProducts()">
                                +
                            </button>
                ...
                <div class="card-body pt-4 p-2">
                    ...
                    <div id="container-items-details">
                        ...
                        <ul class="list-group" id="list-items">
                            ...
                            ?>
                                <a href="<?= base_url() ?>/Document/content?id=<?= $details['MPR_DPV_NUMERO'] ?>&pv=<?= $details['MPR_DPV_PVD_CODIGO'] ?>&pdt=<?= $details['MPR_UPP_PDT_CODIGO'] ?>" data-pdt="<?= $details['MPR_UPP_PDT_CODIGO'] ?>" data-und="<?= $details['MPR_UPP_UND_ID'] ?>" data-exiscj="<?= number_format($details['CAJA'], 2) ?>" data-exisund="<?= number_format($details['UND_KG'], 2) ?>" data-canxund="<?= $details['PDT_LICLTSCAJA'] ?>" data-valor="<?= number_format($details['CAJA'], 2) ?>" data-number="<?= $details['MPR_DPV_NUMERO'] ?>" data-det="<?= $details['MPR_DPV_PVD_CODIGO'] ?>" onclick="setInfoDetails(this)">
                                    <li class="list-group-item  d-flex justify-content-between  mb-2 border-radius-lg <?= $styleClass ?> p-1">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <h6 class="mb-1 text-dark text-sm"><?= $details['MPR_UPP_PDT_CODIGO'] ?> <span class="mx-2 badge rounded-pill bg-warning text-light"> <?= $details['MPR_UPP_UND_ID'] ?></span> <small class="text-danger"><?= $details['PDT_PESO_BALANZA'] == 1 ? $details['PIEZAS'] . 'pzas' : '' ?></small></h6>
                                                <span class="text-xs"><?= $details['MPR_DESCRI'] ?></span>
                                            </div>
                                        </div>
                                ...
                                <div class="overflow-hidden position-relative border-radius-xl">
                                    ...
                                    <div class="card-body position-relative z-index-1 p-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="row">
                                                    <input type="hidden" value="<?= $data['page_dpv_numero']   ?>" id="dpv_numero">
                                                    <input type="hidden" value="<?= $data['page_pvd_codigo']   ?>" id="dpv_pvd">
                                                    <input type="hidden" value="0" id="canxund">
                                                    <input type="hidden" value="0" id="valor">
                                                    <input type="hidden" value="0" id="valor-und">
                                                    <input type="hidden" value="<?= isset($details['DPV_CERRADO']) ? $details['DPV_CERRADO'] : 0 ?>" id="dpv-cerrado">
